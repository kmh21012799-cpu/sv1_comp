...
**★ 이것은 §4 ⑥의 유한시간 착각이며 (C3a에서 다시 만난다), sv-1의 ⑧(잘못된 모델)과는 다른 종류다.**
...
**★ (정정: 이전 판에는 "D1: μ≈1.5 → N=10⁷" 항목이 있었으나, 그 실험은 sv-1에
존재하지 않는다. sv-1의 실제 함정은 ⑧이며 종류가 다르다.)**
